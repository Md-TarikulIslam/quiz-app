        ...
        {showScore? (
          <div>
            ...
            <div className='items'>
              ...
              {allQuestion[count].id}
              <span>. </span>
              {allQuestion[count].question}
              </div>
            <div className='option-area'>
            {
              allQuestion[count].options.map((option)=>(
                
                <button className='btn' onClick={()=>handleButton(option.answer)}>{option}</button>
              ))
            }
            </div>
